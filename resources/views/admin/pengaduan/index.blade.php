                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            title="Tanggapi"
                                                            onclick="openTanggapiModal({{ $pengaduan->id }})"
                                                            data-pengaduan-id="{{ $pengaduan->id }}"
                                                            data-pengaduan-judul="{{ $pengaduan->judul }}"
                                                            data-pengaduan-nomor="{{ $pengaduan->nomor_pengaduan }}"
                                                            data-pengaduan-kategori="{{ $pengaduan->kategori }}"
                                                            data-pengaduan-prioritas="{{ $pengaduan->prioritas }}">
...
<script>
    ...
    // Update character counter di modal
    const tanggapanInput = document.getElementById('tanggapan_admin_modal');
    ...
    // Set pengaduan ID untuk modal tanggapan cepat
    function openTanggapiModal(pengaduanId) {
        const modal = new bootstrap.Modal(document.getElementById('tanggapiModalIndex'));
        document.getElementById('formTanggapiIndex').action = `/admin/pengaduan/${pengaduanId}/tanggapi`;
        modal.show();
    }
</script>

<!-- Modal Tanggapan Cepat dari Index -->
<div class="modal fade" id="tanggapiModalIndex" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 8px 24px rgba(0,0,0,0.15);">
            ...
            <form id="formTanggapiIndex" method="POST">
                @csrf
                <div class="modal-body" style="background: #f8f9fa; max-height: 70vh; overflow-y: auto;">
                    ...
                    <div class="card mb-3" style="border: 1px solid #eef2f9; box-shadow: none;">
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8"><span id="infoNomor" class="font-monospace">-</span></div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-4 text-muted"><strong>Judul:</strong></div>
                                <div class="col-sm-8"><span id="infoJudul">-</span></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4 text-muted"><strong>Kategori:</strong></div>
                                <div class="col-sm-8">
                                    <span id="infoKategori" class="badge" style="background: #667eea; color: white;">-</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea id="tanggapan_admin_modal" name="tanggapan_admin" class="form-control" 
                                  rows="6" 
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select id="prioritasSelect" name="prioritas" class="form-select">
...
<script>
    ...
    document.getElementById('tanggapiModalIndex').addEventListener('show.bs.modal', function() {
        const button = event.relatedTarget;
        if (button) {
            document.getElementById('infoNomor').textContent = button.dataset.pengaduanNomor || '-';
            document.getElementById('infoJudul').textContent = button.dataset.pengaduanJudul || '-';
            document.getElementById('infoKategori').textContent = button.dataset.pengaduanKategori || '-';
            document.getElementById('prioritasSelect').value = button.dataset.pengaduanPrioritas || '';
            document.getElementById('tanggapan_admin_modal').value = '';
