<style>
    ...
    .stat-card:hover {
        ...
        box-shadow: 0 12px 28px rgba(91, 110, 245, 0.12);
        border-color: #5b6ef5;
    }
    ...
    .stat-card-icon {
        ...
        font-size: 32px;
        background: #f0f2ff;
        box-shadow: 0 4px 12px rgba(91, 110, 245, 0.1);
    }
    ...
    .stat-card-1 .stat-card-icon { background: linear-gradient(135deg, #f0f2ff 0%, #e9ebff 100%); color: #5b6ef5; }
    .stat-card-2 .stat-card-icon { background: linear-gradient(135deg, #fff5f7 0%, #ffe9f0 100%); color: #f5365c; }
    .stat-card-3 .stat-card-icon { background: linear-gradient(135deg, #f0f9fb 0%, #e8f7f9 100%); color: #17a2b8; }
    .stat-card-4 .stat-card-icon { background: linear-gradient(135deg, #f0fdf4 0%, #e8fbe9 100%); color: #2dce89; }
    .stat-card-5 .stat-card-icon { background: linear-gradient(135deg, #fffbf0 0%, #fff3e0 100%); color: #ff9500; }
    .stat-card-6 .stat-card-icon { background: linear-gradient(135deg, #f5f6f7 0%, #ececed 100%); color: #6c757d; }
    ...
    .action-card:nth-child(1)::before { background: #ffa500; }
    .action-card:nth-child(2)::before { background: #f5365c; }
    .action-card:nth-child(3)::before { background: #17a2b8; }
    .action-card:nth-child(4)::before { background: #2dce89; }
    .action-card:nth-child(5)::before { background: #6c757d; }
    ...
    .action-card:nth-child(1) .action-card-icon { color: #ffa500; }
    .action-card:nth-child(2) .action-card-icon { color: #f5365c; }
    .action-card:nth-child(3) .action-card-icon { color: #17a2b8; }
    .action-card:nth-child(4) .action-card-icon { color: #2dce89; }
    .action-card:nth-child(5) .action-card-icon { color: #6c757d; }
...
<div class="row dashboard-wrapper">
    ...
    <div class="col-md-12 col-xl-8 mb-4">
        <div class="card elegant-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5><i class="ti ti-file-check me-2" style="color: #667eea;"></i>Pengajuan Surat Terbaru</h5>
    ...
    <div class="col-md-12 col-xl-4 mb-4">
        <div class="card elegant-card">
            <div class="card-header">
                <h5><i class="ti ti-chart-pie me-2" style="color: #667eea;"></i>Status Pengajuan</h5>
            </div>
            <div class="card-body">
                @php
                    $statuses = [
        ...
        <div class="card elegant-card">
            <div class="card-header">
                <h5><i class="ti ti-star me-2" style="color: #667eea;"></i>Jenis Surat Populer</h5>
            </div>
            <div class="card-body">
                @php
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                        <span style="font-weight: 600; color: #2d3748;">{{ Str::limit($surat->jenis_surat, 25) }}</span>
                        <span class="badge badge-custom" style="background: var(--info-gradient); color: white;">{{ $surat->total }}</span>
                    </li>
                    @empty
                    <li class="list-group-item text-center" style="color: #a0aec0;">Belum ada data</li>
                    @endforelse
                </ul>
            </div>
        </div>
    ...
    <div class="col-12 mb-4">
        <div class="card elegant-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5><i class="ti ti-message-circle me-2" style="color: #667eea;"></i>Pengaduan Terbaru</h5>
    ...
    <div class="col-12 mb-4">
        <div class="card elegant-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5><i class="ti ti-death-icon me-2" style="color: #667eea;"></i>Penduduk Meninggal (Terbaru)</h5>
    ...
    <div class="col-md-6 mb-4">
        <div class="card elegant-card">
            <div class="card-header">
                <h5><i class="ti ti-chart-bar me-2" style="color: #667eea;"></i>Statistik Penduduk</h5>
            </div>
            <div class="card-body">
                @php
    ...
    <div class="col-md-6 mb-4">
        <div class="card elegant-card">
            <div class="card-header">
                <h5><i class="ti ti-info-circle me-2" style="color: #667eea;"></i>Detail Penduduk</h5>
            </div>
            <div class="card-body">
                @php
                    $totalPenduduk = \App\Models\Penduduk::count();
